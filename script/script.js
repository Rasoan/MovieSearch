...
async function translate() {
  try {
    ...
    console.log("Слайдер обрабатывает вот это слово ", my_input_search_value);
...
//   await initialize_swider();                  // инициализировать слайдер новыми данными
